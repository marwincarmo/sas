...
\midrule
sas\_1 & 7 & 0 & \num{3.6} & \num{1.9} & \num{1.0} & \num{4.0} & \num{7.0} & \includegraphics[width=0.67in, height=0.17in]{C:/Users/marwi/OneDrive/Documentos/Rprojects/papers/sas/02_data-screening_files/figure-latex/hist_1b54164e50a7.pdf}\\
sas\_2 & 7 & 0 & \num{3.4} & \num{1.8} & \num{1.0} & \num{4.0} & \num{7.0} & \includegraphics[width=0.67in, height=0.17in]{C:/Users/marwi/OneDrive/Documentos/Rprojects/papers/sas/02_data-screening_files/figure-latex/hist_1b544816494f.pdf}\\
sas\_3 & 7 & 0 & \num{3.7} & \num{2.2} & \num{1.0} & \num{4.0} & \num{7.0} & \includegraphics[width=0.67in, height=0.17in]{C:/Users/marwi/OneDrive/Documentos/Rprojects/papers/sas/02_data-screening_files/figure-latex/hist_1b5413746ea1.pdf}\\
sas\_4 & 7 & 0 & \num{3.9} & \num{2.2} & \num{1.0} & \num{4.0} & \num{7.0} & \includegraphics[width=0.67in, height=0.17in]{C:/Users/marwi/OneDrive/Documentos/Rprojects/papers/sas/02_data-screening_files/figure-latex/hist_1b5456c1665d.pdf}\\
sas\_5 & 7 & 0 & \num{3.6} & \num{2.0} & \num{1.0} & \num{4.0} & \num{7.0} & \includegraphics[width=0.67in, height=0.17in]{C:/Users/marwi/OneDrive/Documentos/Rprojects/papers/sas/02_data-screening_files/figure-latex/hist_1b5414b32a32.pdf}\\
sas\_6 & 7 & 0 & \num{4.2} & \num{2.3} & \num{1.0} & \num{4.0} & \num{7.0} & \includegraphics[width=0.67in, height=0.17in]{C:/Users/marwi/OneDrive/Documentos/Rprojects/papers/sas/02_data-screening_files/figure-latex/hist_1b54653153d.pdf}\\
\bottomrule
\end{tabular}
\end{table}
